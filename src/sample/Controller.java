...
//    public static GridPane elevatorsPane;
//    public static Controller shared = new Controller(4, 30, elevatorsPane);

    public Controller(int capacity, int floorsQuantity, GridPane pane) {
        elevators = new ArrayList<>();
        Controller.numberOfElevators = capacity;
        Controller.floorsQuantity = floorsQuantity;
        stopController = false;
        initializeElevators(pane);
    }
    ...
    public Elevator selectElevator(ElevatorCall elevatorRequest) {
        ...
        return findElevator(elevatorState, elevatorRequest, elevatorRequest.getController());
    }

    private static void initializeElevators(GridPane pane) {
        for(int i = 0; i < numberOfElevators; i++){
            Elevator e = new Elevator(i, pane);
    ...
    private static Elevator findElevator(ElevatorState state, ElevatorCall call, Controller c) {
        int fromFloor = call.getFromFloor();
        ...
        ElevatorCall newCall = new ElevatorCall(elevator.getFloor(), fromFloor, c);
